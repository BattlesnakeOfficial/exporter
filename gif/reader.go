...
// PalettAndDelay for channel shennanigans
type PalettAndDelay struct {
	Palett *image.Paletted
	Delay  int
	I      int
}
...
type GIF struct {
	// SampleImage to make the checks work
	SampleImage *image.Paletted
	Image       chan PalettAndDelay // The successive images.
